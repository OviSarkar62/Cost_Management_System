        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('create.income') }}">Add Income</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('list.income')}}">Income List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('create.expense') }}">Add Expense</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('list.expense')}}">Expense List</a>
                    </li>
                    <li class="nav-item">
